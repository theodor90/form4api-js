...
__export(index_exports, {
  AuthError: () => AuthError,
  Form4ApiClient: () => Form4ApiClient,
  GeneratedCompaniesResource: () => GeneratedCompaniesResource,
  GeneratedCongressResource: () => GeneratedCongressResource,
  GeneratedDataQualityResource: () => GeneratedDataQualityResource,
  GeneratedFilingsResource: () => GeneratedFilingsResource,
  GeneratedForm144Resource: () => GeneratedForm144Resource,
  GeneratedHoldingsResource: () => GeneratedHoldingsResource,
  GeneratedInsidersResource: () => GeneratedInsidersResource,
  GeneratedSignalsResource: () => GeneratedSignalsResource,
  GeneratedStatsResource: () => GeneratedStatsResource,
...
var TransactionsResource = class {
  ...
  async list(params = {}) {
    ...
    if (params.from !== void 0) q["from"] = params.from;
    if (params.to !== void 0) q["to"] = params.to;
    if (params.filedFrom !== void 0) q["filed_from"] = params.filedFrom;
    if (params.filedTo !== void 0) q["filed_to"] = params.filedTo;
